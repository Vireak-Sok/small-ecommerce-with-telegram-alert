...
useEffect(() => {
  ...
  <div className="space-y-4">
    ...
    <div className="space-y-2 w-full">
      <label className="block mb-2 text-sm font-bold text-slate-700 ml-1">ឈ្មោះអ្នកទទួល <span className="text-red-500 ml-0.5" aria-hidden="true"> *</span></label>
      <input 
        type="text" 
    ...
    {/* Phone Number */}
    <div className="space-y-2 w-full">
      <label className="block mb-2 text-sm font-bold text-slate-700 ml-1">លេខទូរសព្ទ <span className="text-red-500 ml-0.5" aria-hidden="true"> *</span></label>
      <input 
        type="tel" 
    ...
    {/* Province Selection */}
    <div className="space-y-2 w-full">
      <label className="block mb-2 text-sm font-bold text-slate-700 ml-1">ខេត្ត/ក្រុង <span className="text-red-500 ml-0.5" aria-hidden="true"> *</span></label>
    ...
    {/* Detailed Address */}
    <div className="space-y-2 w-full">
      <label className="block mb-2 text-sm font-bold text-slate-700 ml-1">អាសយដ្ឋានលម្អិត <span className="text-red-500 ml-0.5" aria-hidden="true"> *</span></label>
      <textarea 
